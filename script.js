...
form.addEventListener("submit", (e) => {
    ...
    let data = {
        ...
        tq1: registrationData.get("UserQ1") || "Ответ не получен",
        tg2: registrationData.get("UserQ2") || "Ответ не получен",
        tg3: registrationData.get("UserQ3") || "Ответ не получен",
        tg4: registrationData.get("UserQ4") || "Ответ не получен",
        tg5: registrationData.get("UserQ5") || "Ответ не получен"
    }
